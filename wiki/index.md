...
| [[routing-evals]] | E1 — 34 generated cases prove each trigger phrase fires its skill; headless `claude -p`, threshold 1.0, run locally; `validate.sh` §11 keeps the list honest. |
